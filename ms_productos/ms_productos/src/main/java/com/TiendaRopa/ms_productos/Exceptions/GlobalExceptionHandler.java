...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleCategoriaNotFound(
        ...
        log.error("Categoría no encontrada en {}: {}", request.getRequestURI(), ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handlePrecioInvalido(
            PrecioInvalidoException ex,
            HttpServletRequest request) {

        log.error("Precio inválido en {}: {}", request.getRequestURI(), ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleProductoDuplicado(
        ...
        log.error("Producto duplicado en {}: {}", request.getRequestURI(), ex.getMessage());
